...
export declare const CrystalCompressor: {
    ...
    version: number;
    compressArray(array: TypedArrays): Promise<Uint8Array>;
    decompressArray(buffer: ArrayBuffer, type: TypeArraysNames): Promise<Uint8Array | Int8Array | Uint8ClampedArray | Int16Array | Uint16Array | Int32Array | Uint32Array | Float32Array | Float64Array | BigInt64Array | BigUint64Array>;
};
